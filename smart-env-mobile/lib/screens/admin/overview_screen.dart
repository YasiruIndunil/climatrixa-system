...
class AdminOverviewScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final predicted =
        alerts.where((a) => a.isPredicted && !a.acknowledged).length;
    final anomalies =
        alerts.where((a) => a.isAnomaly && !a.acknowledged).length;
    return Scaffold(
      appBar: AppBar(
        ...
        title:
            const Text('Admin Overview', style: TextStyle(color: Colors.white)),
        actions: [
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    ...sensors.take(5).map((s) {
                      ...
                      final hasAlert = alerts
                          .any((a) => a.sensorId == s.id && !a.acknowledged);
                      return Padding(
                          ...
                          child: Row(children: [
                            ...
                            const SizedBox(width: 8),
                            Text(s.isActive ? 'Active' : 'Offline',
                                style: TextStyle(
                                    fontSize: 9,
          ...
          Container(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    if (alerts.where((a) => !a.acknowledged).isEmpty)
                    ...
                    GridView.count(
                        ...
                        children: [
                          _ActionBtn(
                              ...
                              Icons.add,
                              const Color(0xFF14B8A6),
                              () => context.go('/admin/sensor/new')),
                          _ActionBtn('Add User', Icons.person_add, purple,
