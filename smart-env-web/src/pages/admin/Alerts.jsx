...
const ALERT_TYPES = [
  ...
  'aqi_high', 'pressure_high', 'pressure_low'
]
    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl">
        <div className="px-6 py-4 border-b border-gray-100">
          <h3 className="font-semibold text-gray-800">Add alert rule</h3>
        </div>
        <form onSubmit={handleSubmit} className="px-6 py-4 space-y-4">
          ...
          <div>
            <label className="block text-xs font-medium text-gray-600 mb-1">Notify email</label>
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Configure threshold-based alerts</p>
        </div>
        <button
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100">
        <div className="px-5 py-4 border-b border-gray-100">
          <h2 className="font-semibold text-gray-800 text-sm">Active rules</h2>
        </div>
            ...
            <div key={rule.id} className="px-5 py-4 flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-gray-400">
                  Threshold: {rule.threshold_value} · {rule.notify_email || 'No email'}
                </div>
              </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100">
        <div className="px-5 py-4 border-b border-gray-100">
          <h2 className="font-semibold text-gray-800 text-sm">Recent alert events</h2>
        </div>
        <div className="divide-y divide-gray-50">
          {events?.slice(0, 10).map(event => (
            <div key={event.id} className="px-5 py-3 flex items-start gap-3">
              ...
              <div className="text-xs text-gray-500">
                Actual: <strong>{event.actual_value}</strong>
              </div>
            </div>
          )) ?? (
